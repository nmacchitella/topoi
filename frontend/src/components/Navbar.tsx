      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="hidden sm:block relative">
          <button
            ...
            className="flex items-center gap-2 text-white px-4 py-2 hover:bg-dark-hover rounded transition-colors"
          >
          ...
          {showUserDropdown && (
            <>
              ...
              />
              {/* Dropdown menu */}
              <div className="absolute right-0 mt-2 w-48 bg-dark-card border border-gray-600 rounded-lg shadow-xl z-50">
                <button
                  onClick={() => {
                    router.push('/');
                    setShowUserDropdown(false);
                  }}
                  className="w-full text-left px-4 py-3 hover:bg-dark-hover transition-colors text-gray-300 hover:text-white flex items-center gap-3"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 hover:bg-dark-hover transition-colors text-red-400 hover:text-red-300 flex items-center gap-3 rounded-b-lg"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
